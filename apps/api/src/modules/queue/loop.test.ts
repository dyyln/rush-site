...
describe("mode order", () => {
  it("puts every mode first once every five ticks", () => {
    expect(modeOrder(0)).toEqual(["aim1v1", "aim2v2", "rush3v3", "rush1v1", "rush2v2"])
    expect(modeOrder(1)).toEqual(["aim2v2", "rush3v3", "rush1v1", "rush2v2", "aim1v1"])
    expect(modeOrder(2)).toEqual(["rush3v3", "rush1v1", "rush2v2", "aim1v1", "aim2v2"])
    expect(modeOrder(3)).toEqual(["rush1v1", "rush2v2", "aim1v1", "aim2v2", "rush3v3"])
    expect(modeOrder(4)).toEqual(["rush2v2", "aim1v1", "aim2v2", "rush3v3", "rush1v1"])
    expect(modeOrder(5)).toEqual(modeOrder(0))
  })
