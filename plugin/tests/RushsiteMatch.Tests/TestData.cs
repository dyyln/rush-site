...
internal static class TestData
{
    ...
    public static MatchConfig Aim1v1() => MatchConfigLoader.Parse(Json("aim1v1", "first_to_16", 1));
    public static MatchConfig Aim2v2() => MatchConfigLoader.Parse(Json("aim2v2", "first_to_16", 2));
}
